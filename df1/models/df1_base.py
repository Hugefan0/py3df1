...
class TIMER(Enum):
    ...
    TI = 0x02  # TT bit only (Timer Timing)
...
class Df1BaseClient:
    def __init__(self,
                #plc_type='MicroLogix 1000', src=0, dst=1,
                plc_type= str,
                src= int,
                dst= int,
                seq_sleep_time= 0.01,
                timeout_read_msg= 0.5,
                timeout= 3,
                history_size= 20):
    ...
    def write_o(self, file_table=int, start=int, data=[]):
        """
    ...
    def write_b(self, file_table=int, start=int, data=[]):
        """
    ...
    def write_r(self, file_table=int, start=0, data=[]):
        """
    ...
    def write_f(self, file_table=int, start=int, data=[]):
        """
    ...
    def read_o(self, file_table=int, start=0, bit=int, total_int=1) -> list():
        """
    ...
    def read_i(self, file_table=int, start=0, bit=int, total_int=1) -> list():
        """
    ...
    def read_t(self, file_table=int, start=int, category=str, total_int=1) -> list():
        """
    ...
    def read_c(self, file_table=int, start=int, category=str, total_int=1) -> list():
        """
        ...
        if category == 'CU':
            ...
            category = COUNTER.PRE
        elif category == 'ACC':
            category = COUNTER.ACC
    ...
    def read_r(self, file_table=int, start=int, total_int=int) -> list():
        """
    ...
    def read_n(self, file_table=int, start=int, total_int=int) -> list():
        """
    ...
    def read_f(self, file_table=int, start=int, total_float=int) -> list():
        """
